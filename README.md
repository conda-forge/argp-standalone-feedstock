...
<table><tr>
    <td>Travis</td>
    <td>
      <a href="https://travis-ci.com/conda-forge/argp-standalone-feedstock">
        <img alt="macOS" src="https://img.shields.io/travis/com/conda-forge/argp-standalone-feedstock/master.svg?label=macOS">
      </a>
    </td>
  </tr>
...
Once the `conda-forge` channel has been enabled, `argp-standalone` can be installed with:

```
conda install argp-standalone
```

It is possible to list all of the versions of `argp-standalone` available on your platform with:
